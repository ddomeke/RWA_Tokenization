...
contract Fexse is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes {
     ...
     */
    function lock(address owner, uint256 amount) external onlyOwnerOrRWAContract{
     ...
     */
    function unlock(address owner, uint256 amount) external onlyOwnerOrRWAContract {
